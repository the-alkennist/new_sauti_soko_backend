...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://sautisoko-production.up.railway.app']
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = True  # to expire sessions when the browser is closed
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "A Rentals_management API built using Django Rest Framework",
    "VERSION": "1.0.0",
